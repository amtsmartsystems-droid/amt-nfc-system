...
export default function ClientCardViewer({ initialCard, cardId }) {
    ...
    /* ΓöÇΓöÇ Smart Waiter State ΓöÇΓöÇ */
    ...
    const handleWaiterRequest = async (serviceType) => {
        ...
        try {
            ...
            if (res.ok) {
                setWaiterToast({ message: data.message || "╪¬┘à ╪Ñ╪▒╪│╪º┘ä ╪╖┘ä╪¿┘â ┘ä┘ä┘ê┘è╪¬╪▒ ╪¿┘å╪¼╪º╪¡! ≡ƒÜÇ", type: 'success' });
            } else {
                setWaiterToast({ message: data.error || "╪╣╪░╪▒╪º┘ï╪î ╪¡╪»╪½ ╪«╪╖╪ú", type: 'error' });
                setCooldown(5); // reduced cooldown on error
            }
        } catch(e) {
            setWaiterToast({ message: "╪«╪╖╪ú ┘ü┘è ╪º┘ä╪º╪¬╪╡╪º┘ä ╪¿╪º┘ä╪«╪º╪»┘à", type: 'error' });
            setCooldown(5);
        }
        ...
        return (
            <div className="min-h-screen flex items-center justify-center bg-slate-100" dir="rtl">
                <div className="text-center p-8 bg-white rounded-3xl shadow-xl max-w-sm border border-slate-200 mx-4">
                    ...
                    <h1 className="text-xl font-black mb-2 text-slate-900">╪º┘ä╪¿╪╖╪º┘é╪⌐ ┘à┘é┘ü┘ä╪⌐ ┘à╪ñ┘é╪¬╪º┘ï</h1>
                    <p className="text-sm text-slate-500">┘ç╪░┘ç ╪º┘ä╪¿╪╖╪º┘é╪⌐ ╪║┘è╪▒ ┘à┘ü╪╣┘ä╪⌐ ╪¡╪º┘ä┘è╪º┘ï. ┘è╪▒╪¼┘ë ╪º┘ä╪¬┘ê╪º╪╡┘ä ┘à╪╣ ╪º┘ä╪Ñ╪»╪º╪▒╪⌐.</p>
                </div>
            </div>
        );
    }

    /* ΓöÇΓöÇ Build props ΓöÇΓöÇ */
    ...
    /* ΓöÇΓöÇ Shared pill button style ΓöÇΓöÇ */
    ...
    /* ΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉ
       AMT BUSINESS CARD ΓÇö full-bleed dark landing page
    ...
    /* ΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉ
       RESTAURANT / CAFE THEMES ΓÇö normal wrapper with pill buttons
    ΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉ */
    return (
        <>
            {/* ΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉ WI-FI TOAST (fixed, portal-like) ΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉ */}
            {hasWifi && (
                <div style={{
                    position:   'fixed',
                    bottom:     20,
                        ...
                        <div style={{ display:'flex', alignItems:'flex-start', gap:12, padding:'14px 16px' }} dir={lang==='ar'?'rtl':'ltr'}>
                            ...
                            <div style={{ flex:1, minWidth:0 }}>
                                <p style={{ fontSize:13.5, fontWeight:900, color:'#fff', margin:'0 0 6px', lineHeight:1.3 }}>
                                    {lang==='ar' ? '╪¬┘à ┘å╪│╪« ╪º┘ä╪¿╪º╪│┘ê┘ê╪▒╪»! ≡ƒÄë' : 'Password copied! ≡ƒÄë'}
                                </p>
                                <div style={{ display:'inline-flex', alignItems:'center', gap:6, padding:'3px 10px', borderRadius:8, background:`${primary}18`, border:`1px solid ${primary}28`, marginBottom:6 }}>
                                    ...
                                    <span style={{ fontSize:11, fontFamily:'monospace', fontWeight:700, color:primary, letterSpacing:'0.06em' }}>{wifi.ssid||'ΓÇö'}</span>
                                </div>
                                <p style={{ fontSize:11, color:'#64748b', lineHeight:1.5, margin:0 }}>
                                    {lang==='ar' ? '╪º╪░┘ç╪¿ ┘ä╪Ñ╪╣╪»╪º╪»╪º╪¬ ╪º┘ä┘ê╪º┘è ┘ü╪º┘è ┘ê╪º┘ä╪╡┘é┘ç ≡ƒô▓' : 'Go to Wi-Fi settings and paste it ≡ƒô▓'}
                                </p>
                            </div>
            ...
            {/* ΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉ PAGE WRAPPER ΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉ */}
            <div style={{ background: props.siteColors.background, minHeight: '100vh' }}>
                <div
                    style={{
                        ...
                        position:  'relative',   // ΓåÉ key: absolute children anchor here
                        overflowX: 'hidden',
                    }}
                >
                    {/* ΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇ
                        FLOATING PILL BUTTONS ΓÇö absolute over hero image
                    ...
                    <div style={{
                        ...
                        >
                            ...
                            <span style={{ paddingTop: 1 }}>{lang === 'ar' ? 'EN' : '╪╣╪▒╪¿┘è'}</span>
                        </button>
                        ...
                        {hasWifi && (
                            ...
                            >
                                {wifiState === 'copied' ? (
                                    <><Check size={13} color="#fff" strokeWidth={3}/><span style={{paddingTop:1}}>{lang==='ar'?'╪¬┘à Γ£ô':'Done Γ£ô'}</span></>
                                ) : (
                                    <><Wifi size={13} color={primary} strokeWidth={2.5}/><span style={{paddingTop:1}}>{lang==='ar'?'┘ê╪º┘è ┘ü╪º┘è':'Wi-Fi'}</span></>
                                )}
                            </button>
                        )}
                    </div>

                    {/* ΓöÇΓöÇ Restaurant / Cafe Theme Content ΓöÇΓöÇ */}
                    ...
                    {/* ΓöÇΓöÇ AMT Branding Footer ΓöÇΓöÇ */}
                    <div style={{
                        textAlign:  'center',
            ...
            {/* ΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉ SMART WAITER TOAST ΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉ */}
            {waiterToast && (
                <div style={{
            ...
            {/* ΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉ SMART WAITER FABs ΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉ */}
            {card.isWaiterEnabled && tableNumber && (
                <div style={{
                    ...
                    <div style={{
                        ...
                        {[
                            { id: 'bill',   label: '╪¡╪│╪º╪¿',  icon: '≡ƒÆ╕' },
                            { id: 'coal',   label: '┘ü╪¡┘à',   icon: '≡ƒÆ¿' },
                            { id: 'clean',  label: '╪¬┘å╪╕┘è┘ü', icon: '≡ƒº╣' },
                            { id: 'waiter', label: '┘ê┘è╪¬╪▒',  icon: '≡ƒöö' },
                        ].map(btn => (
                            <button key={btn.id}
                                ...
                                <span style={{ fontSize: 20 }}>{cooldown > 0 ? 'ΓÅ│' : btn.icon}</span>
