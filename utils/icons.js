...
// ══════════════════════════════════════════════════════════════════════
//  SMART ICON ENGINE — Custom Brands + Lucide
// ══════════════════════════════════════════════════════════════════════
...
const RULES = [
  // Social — Now using custom BrandIcons mapping
  { kw: ["instagram","انستا","انستغرام","ig"],              icon:"Instagram",     color:"#E1306C", bg:"#fce4ec", isBrand: true },
  { kw: ["whatsapp","واتس","واتساب"],                        icon:"WhatsApp",      color:"#25D366", bg:"#e8f5e9", isBrand: true },
  { kw: ["telegram","تيليغرام","تيليجرام","تلغرام"],         icon:"Send",          color:"#229ED9", bg:"#e3f2fd", isBrand: false },
  { kw: ["tiktok","تيك توك","تيك"],                          icon:"Tiktok",        color:"#010101", bg:"#f0f0f0", isBrand: true },
  { kw: ["facebook","فيسبوك","fb","فيس"],                    icon:"Facebook",      color:"#1877F2", bg:"#e8f0fe", isBrand: true },
  { kw: ["twitter","تويتر","tweet","x.com","x"],             icon:"Twitter",       color:"#1DA1F2", bg:"#e8f4fd", isBrand: true },
  { kw: ["youtube","يوتيوب","yt"],                           icon:"Youtube",       color:"#FF0000", bg:"#ffebee", isBrand: true },
  { kw: ["snapchat","سناب","snap"],                          icon:"Snapchat",      color:"#FFCC00", bg:"#fffde7", isBrand: true },
  { kw: ["linkedin","لينكدإن","لينكد"],                      icon:"Linkedin",      color:"#0A66C2", bg:"#e8f0fe", isBrand: true },
  { kw: ["threads","ثريدز"],                                 icon:"AtSign",        color:"#000000", bg:"#f5f5f5", isBrand: false },

  // Food & Restaurant
  { kw: ["menu","منيو","قائمة","قائمه","food","طعام"],       icon:"Utensils",      color:"#F59E0B", bg:"#fff8e1", isBrand: false },
  { kw: ["reserve","reservation","حجز","احجز","table"],      icon:"CalendarDays",  color:"#8B5CF6", bg:"#ede9fe", isBrand: false },
  { kw: ["order","اطلب","طلب","delivery","توصيل"],           icon:"ShoppingBag",   color:"#10B981", bg:"#d1fae5", isBrand: false },
  { kw: ["offer","discount","خصم","عرض","promo"],             icon:"Tag",           color:"#EC4899", bg:"#fce7f3", isBrand: false },
  { kw: ["cake","كيك","pastry","حلويات","bakery","مخبوزات"], icon:"CakeSlice",     color:"#F97316", bg:"#fff7ed", isBrand: false },
  { kw: ["coffee","قهوة","كافيه","cafe","espresso"],          icon:"Coffee",        color:"#6B4226", bg:"#efebe9", isBrand: false },

  // Contact & Location
  { kw: ["save", "contact", "حفظ", "جهة اتصال", "vcard"], icon:"UserPlus", color:"#10B981", bg:"#d1fae5", isBrand: false },
  { kw: ["location","موقع","خريطة","map","directions","اتجاهات","لوكيشن"], icon:"MapPin", color:"#EF4444", bg:"#fee2e2", isBrand: false },
  { kw: ["phone","call","هاتف","اتصل","اتصال","تلفون"],      icon:"Phone",         color:"#3B82F6", bg:"#dbeafe", isBrand: false },
  { kw: ["email","mail","بريد","إيميل","ايميل"],              icon:"Mail",          color:"#6366F1", bg:"#ede9fe", isBrand: false },
  { kw: ["website","site","موقع الكتروني","web"],             icon:"Globe",         color:"#0EA5E9", bg:"#e0f2fe", isBrand: false },

  // Commerce
  { kw: ["shop","store","متجر","محل","buy","شراء","merch"],   icon:"ShoppingCart",  color:"#F97316", bg:"#fff7ed", isBrand: false },
  { kw: ["review","rating","تقييم","stars"],                  icon:"Star",          color:"#F59E0B", bg:"#fff8e1", isBrand: false },
  { kw: ["pdf","catalog","catalogue","كتالوج"],               icon:"FileText",      color:"#64748B", bg:"#f1f5f9", isBrand: false },
  { kw: ["about","عنا","من نحن"],                             icon:"Info",          color:"#6B7280", bg:"#F3F4F6", isBrand: false },
];
...
export function getIconForLink(title = "") {
  ...
  for (const rule of RULES) {
    if (rule.kw.some((k) => lower.includes(k.toLowerCase()))) {
      const IconComponent = rule.isBrand ? BrandIcons[rule.icon] : (LucideIcons[rule.icon] || LucideIcons.Link2);
