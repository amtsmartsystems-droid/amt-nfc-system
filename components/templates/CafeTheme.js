...
// ══════════════════════════════════════════════════════════════════════
export default function CafeTheme({ cardId, siteData, siteColors, lang = "en", isMenuEnabled, menuMode, isHouseSystemActive, menuCategories, addToCart, pdfMenuUrl, showMenuImages, isPreview, onUpdateLayoutBlocks, isWYSIWYG, onUpdateField, onImageUpload, onAddLink, onEditLink, onUpdateLink, onRemoveLink, footerComponent }) {
          ...
          case 'header':
              return (
                  <section className="relative px-6 pt-14 pb-10 text-center overflow-hidden" style={{ cursor: isPreview ? 'grab' : 'default' }}>
                      ...
                      <div className="relative z-10 mx-auto w-[88px] h-[88px] rounded-full flex items-center justify-center mb-6 shadow-deep pointer-events-auto"
                           style={{ background: primary }}>
                        <EditableImage
                            src={imgs.profile || "data:image/svg+xml;utf8,%3Csvg xmlns='http://www.w3.org/2000/svg' width='36' height='36' viewBox='0 0 24 24' fill='none' stroke='%23ffffff' stroke-width='2' stroke-linecap='round' stroke-linejoin='round'%3E%3Cpath d='M17 8h1a4 4 0 1 1 0 8h-1'/%3E%3Cpath d='M3 8h14v9a4 4 0 0 1-4 4H7a4 4 0 0 1-4-4Z'/%3E%3Cline x1='6' x2='6' y1='2' y2='4'/%3E%3Cline x1='10' x2='10' y1='2' y2='4'/%3E%3Cline x1='14' x2='14' y1='2' y2='4'/%3E%3C/svg%3E"}
                            alt={name}
                            isWYSIWYG={isWYSIWYG}
                            onImageUpload={(file) => onImageUpload && onImageUpload('profile', file)}
                            className={imgs.profile ? "w-full h-full rounded-full object-cover" : "w-9 h-9 object-contain"}
                        />
                      </div>
                      <EditableText
                          value={name}
                          ...
                          style={{ color: primary, textTransform:"uppercase", fontFamily:"Cairo,sans-serif" }}
                      />
                      <EditableText
                          value={sub}
                          ...
                          style={{ color: primary, fontFamily:"Cairo,sans-serif" }}
                      />
                  ...
                  <section className="px-5 pb-8" style={{ cursor: isPreview ? 'grab' : 'default' }}>
                      ...
                      {about && (
                          <EditableText
                              ...
                              style={{ color: primary, opacity:.7, fontFamily:"Cairo,sans-serif" }}
                          />
                      )}
                      {address && (
