            ...
            <div className="px-6 mt-6">
              ...
              >
                <div className="flex items-center gap-3 mb-5 border-b border-red-500/10 pb-3">
                  <div className="w-10 h-10 rounded-full flex items-center justify-center bg-red-900/30 text-red-500">
                    <LucideIcons.HeartPulse size={20} />
                  </div>
                  <h3 className="font-black text-red-500 text-[16px]" style={{ fontFamily: 'Cairo,sans-serif' }}>
                ...
                <div className="space-y-4 font-medium text-[13px] text-gray-300" style={{ fontFamily: 'Cairo,sans-serif' }}>
                  ...
                  {sd.allergies && (
                    <div>
                      ...
                      <p className="bg-white/5 p-3 rounded-xl border border-red-500/10">{sd.allergies}</p>
                    </div>
                  )}
                  {sd.chronicDiseases && (
                    <div>
                      <span className="block text-red-400 text-[11px] mb-1 font-bold">{t("Chronic Diseases", "أمراض مزمنة")}</span>
                      <p className="bg-white/5 p-3 rounded-xl border border-red-500/10">{sd.chronicDiseases}</p>
                    </div>
                  )}
                  {sd.medicalNotes && (
                    <div>
